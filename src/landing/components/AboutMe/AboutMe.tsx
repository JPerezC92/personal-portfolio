      ...
      >
        ...
        >
          <Text as="p" fontStyle="L1">
            Soy desarrollador orientado a front-end, autodidacta, apasionado por
            la programación y la tecnología, procedente de Ancash,{' '}
            <strong>Perú</strong>. Comencé estudiando programación por cuenta
            propia un par de meses después ingresé a estudiar en{' '}
            <strong>SENATI</strong> la carrera de desarrollo de software
            (2019-2021).
          </Text>
