        ...
        {projectList.map((v) => (
          <Box as="li" key={v.title}>
            ...
            >
              ...
              >
                <Heading as="h3" fontStyle="L4" css={{ textAlign: 'center' }}>
                  {v.title}
                </Heading>
                ...
                <Box>
                  <Text as="h4" fontStyle="L1" textStyle="allCaps">
                    Tecnologias
                  </Text>
                  ...
                  >
                    {v.tecnologieList.map((v, i) => (
                      <Box key={i} as="li" css={{ display: 'block' }}>
                        <Icon
                          asIcon={v.icon}
                          title={v.name}
                          size="sm"
                          css={{ color: '$special2_400' }}
                        />
                      </Box>
                    ))}
                  </Box>
                ...
                >
                  <Link href={v?.site} passHref>
                    <Button
                      ...
                      target="_blank"
                      title="Demo"
                      css={{ display: v.site ? 'flex' : 'none' }}
                    >
                      <Icon asIcon={BiLinkExternal} size="md" /> Demo
                    </Button>
                  </Link>
                  ...
                  <Link href={v?.repository} passHref>
                    <Button
                      ...
                      target="_blank"
                    >
                      <Icon asIcon={DiGit} size="md" /> Repositorio
                    </Button>
                  </Link>
                </Box>
              </Box>
